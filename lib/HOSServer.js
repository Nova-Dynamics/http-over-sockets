...
class HOSServer {
     ...
     *
     * @param {Object} [config={}]
     * @param {number} [config.timeout=10000] - milliseconds to wait for HTTP response before timing out
     * @param {String} [config.resopnse_encoding="utf-8"] - encoding of HTTP response body
     */
     ...
     * Handle a request
     *
     * @param {HOSRequestObject} obj
     * @param {Function} cb - callback function to handle response: expects signature: `(HOSResponse) => {}`
     */
    handle(obj, cb) {
